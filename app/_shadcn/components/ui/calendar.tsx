  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        outside: cn(
          "text-secondary-foreground aria-selected:text-secondary-foreground opacity-50",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[today=true]:bg-accent data-[today=true]:text-accent-foreground data-[today=true]:font-semibold",

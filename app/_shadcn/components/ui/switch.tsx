...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      data-slot="switch"
      className={cn(
        "inline-flex h-5 w-8 shrink-0 items-center rounded-full cursor-pointer transition-all",
        "disabled:cursor-not-allowed disabled:opacity-50",
        "peer data-[state=checked]:bg-primary data-[state=unchecked]:bg-hover dark:data-[state=unchecked]:bg-input/80",
        className
      )}
      {...props}
    >
